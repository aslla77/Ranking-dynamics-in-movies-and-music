...
# # # ======================================================================================================================================================================
# # # =============item part  (didn't cut data with N_b)!!!!!========================================================================================================================
# # # ======================================================================================================================================================================
# data lord
import boxp
with open(file='./ott2/data/netflix.pickle', mode='rb') as f:
    Netflix=pickle.load(f)

with open(file='./ott2/data/hbo.pickle', mode='rb') as f:
    Hbo=pickle.load(f)

with open(file='./ott2/data/disney.pickle', mode='rb') as f:
    Disney=pickle.load(f)

with open(file='./ott2/data/prime.pickle', mode='rb') as f:
    Prime=pickle.load(f)

with open(file='./ott2/data/tw.pickle', mode='rb') as f:
    Tw=pickle.load(f)

with open(file='./ott2/data/gb.pickle', mode='rb') as f:
    UK=pickle.load(f)

with open(file='./ott2/data/us.pickle', mode='rb') as f:
    USA=pickle.load(f)

with open(file='./ott2/data/au.pickle', mode='rb') as f:
    AU=pickle.load(f)
...
# #@title it_barplot
    ...
    save_fig('SI_PDF_max_rank')
    plt.close()
    print('SI_PDF_max_rank')
...
if first_PDF:
    ...
    save_fig('SI_PDF_first_rank')
    plt.close()
    print('SI_PDF_first_rank')
...
if last_PDF:
    ...
    save_fig('SI_PDF_last_rank')
    plt.close()
    print('SI_PDF_last_rank')
...
if last_first_PDF:
    ...
    fig_7_set(A,Hbo)
    fig_8_set(A,Hbo)
    line1, = plt.plot([],[],linestyle='-',         # line style
    color='black',          # line color
    marker='o',            # marker shape
    markerfacecolor='red', # marker inside color
    markeredgecolor='red',
    lw=3,
    ms=10)

    line2, = plt.plot([],[],linestyle='-',         # line style
    color='black',          # line color
    marker='o',            # marker shape
    markerfacecolor='blue', # marker inside color
    markeredgecolor='blue',
    lw=3,
    ms=10)

    plt.legend([line1, line2], ['Last rank', 'First Rank'],fontsize=35)
    ...
    save_fig('SI_PDF_last_first')
    plt.close()
    print('SI_PDF_last_first')
